...
class _EditProfileScreenState extends ConsumerState<EditProfileScreen> {
  ...
  void _populateFields(UserProfile profile) {
    ...
    if (profile.uiTheme.isNotEmpty) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ref.read(themeNotifierProvider.notifier).setThemeFromString(profile.uiTheme);
      });
    }
    
    if (profile.preferredLanguage.isNotEmpty) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ref.read(localeProvider.notifier).setLocale(Locale(profile.preferredLanguage));
      });
    }
  }
          ...
          child: Column(
            ...
            children: [
              ...
              ProfileFormFields(
                ...
                onSportingLevelChanged: (value) => setState(() => _sportingLevel = value),
                onSportPreferencesChanged: (preferences) => setState(() => _sportPreferences = preferences),
                onUnitSystemChanged: (value) => setState(() => _preferredUnitSystem = value),
